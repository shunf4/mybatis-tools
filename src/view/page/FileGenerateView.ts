                ...
                <form>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col input-group mb-3">
                                        <span class="input-group-text">顶级包</span>
                                        <input type="text" class="form-control" id="parentPackageId"/>
                                    </div>
                                    <div class="col input-group mb-3">
                                        <span class="input-group-text">entity包(相对顶级)</span>
                                        <input type="text" class="form-control" id="entityPathId"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col input-group mb-3">
                                        <span class="input-group-text">mapper接口包</span>
                                        <input type="text" class="form-control" id="interfacePathId"/>
                                    </div>
                                    <div class="col input-group mb-3">
                                        <span class="input-group-text">mapper xml路径</span>
                    ...
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-sm-1 form-check" onclick="listDbEnv('mysql')">
                                        <input class="form-check-input" type="radio" name="dbEnv" id="listDbEnv1"
                                               value="mysql"
                                               checked>
                                    ...
                                    <div class="col-sm-1 form-check" onclick="listDbEnv('oracle')">
                                        <input class="form-check-input" type="radio" name="dbEnv" id="listDbEnv2"
                                               value="oracle">
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-sm-2 form-check form-switch">
                                        <label class="form-check-label">lombok</label>
                                        <input class="form-check-input" type="checkbox" role="switch"
                                               id="isUseLombokId">
                                    </div>
                                    <div class="col-sm-2 form-check form-switch">
                                        <label class="form-check-label">swagger</label>
                                        <input class="form-check-input" type="checkbox" role="switch" id="isSwaggerId">
                                    </div>
                                    <br>
                                    <br>
                                    <div class="input-group mb-3">
...
<script type="text/javascript">
    ...
    function generateFile() {
        ...
        let data = {
            ...
            parentPackage: document.getElementById('parentPackageId').value,
            ...
            isUseLombok: document.getElementById('isUseLombokId').checked,
            isSwagger: document.getElementById('isSwaggerId').checked,
        }
